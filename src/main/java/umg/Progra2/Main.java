...
public class Main {
    ...
    private static void PruebaInsertaUsuario() {
       ...
       /* UserService userService=new UserService();
        ...
        user.setCarne("0905-23-5575");
        user.setNombre("Nayeli Urrutia");
        user.setCorreo("NayeliUrrutia@gmail.com");
        user.setSeccion("A");
        user.setTelegramid(6699823249L);
        user.setActivo("Y");
    ...
    private static void PruebaEliminarUsuariocarne() {
        UserService servicioUsuaio = new UserService();
        try {
            servicioUsuaio.deleteUserBycarne("0905-23-5575");
            System.out.println("User deleted successfully!");
        } catch (SQLException e) {
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            botCuestionario bott = new botCuestionario();
            botsApi.registerBot(bott);
