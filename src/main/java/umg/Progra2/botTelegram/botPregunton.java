...
public class botPregunton extends TelegramLongPollingBot {
    ...
    public botPregunton() {
        ...
        preguntas.put("SECTION_2", new String[]{"Pregunta 2.1", "Cuantos años tienes?", "Pregunta 2.3"});
        preguntas.put("SECTION_3", new String[]{"Pregunta 3.1", "Pregunta 3.2", "Pregunta 3.3"});
        preguntas.put("SECTION_4", new String[]{"¿ya comiste?", "¿Tenes hambre?", "¿se te antoja una amburgesa?", "¿has comido una pizza?", "¿has ido a un restaurante?", " ¿Te gustan las gaseosas?"
